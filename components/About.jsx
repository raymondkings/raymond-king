...
const infoData = [
    ...
    
    {
        ...
        text: 'raymond08.de@gmail.com'
    },
    {
        icon: <Calendar size={20}/>,
        text: 'Born on 5 Mar, 2002'
    },
    {
        icon: <GraduationCap size={20}/>,
        text: 'CS B.Sc, 4th Semester @TUM'
    },
    {
        icon: <HomeIcon size={20}/>,
        text: 'Schwabing, Munich'
    },
]
...
const qualificationData = [
        ...
        data: [
            {
                ...
                years: '2022-2025 (present)',
            },
            {
                university: 'Studienkolleg am KIT',
                qualification: 'T-Kurs , Feststellungsprüfung',
                years: '2021-2022',
            },
            {
                university: 'Karangturi Senior High School',
                qualification: 'Indonesian National Exam',
                years: '2017-2020',
            },
        ]
    }, 

    {
        ...
        data: [
            ...
            {
                company: 'Michelin Tyres Company',
                role: 'Production Staff',
                years: '07.2021 - 09.2021',
            },
        ]
    }
]
                        ...
                        <div className="text.lg mt-12 xl:mt-8">
                            ...
                            <TabsContent value="personal"> 
                                <div className="text-center xl:text-left">
                                    ...
                                    <p className="subtitle max-w-xl max-auto xl:mx-0">I specialize in crafting intuitive website with cutting-edge technology, delivering dynamic and engaging user experiences</p>    
                                        */
                                    }
